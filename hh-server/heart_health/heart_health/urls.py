...
urlpatterns = patterns('',
	...
	url(r'^assess/', 'survey.views.assess', name='Detail'),
	url(r'^locate/get/', 'survey.views.locate_get', name='Get Screening Locations'),
	url(r'^locate/savepreferred', 'survey.views.locate_save_preferred', name='Save a Preferred Screening Center'),
	...
	url(r'^results/full/', 'survey.views.results_full', name='Complete Results'),
